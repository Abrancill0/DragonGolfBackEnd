...
namespace DragonGolfBackEnd.Controllers
{
    ...
    public class ListaAmigosController : ApiController
    {
       ...
       usu_nombre = Convert.ToString(row["IDCourse"]),
        usu_apellido_paterno = Convert.ToString(row["IDCourse"]),
         usu_apellido_materno = Convert.ToString(row["IDCourse"]),
         usu_email = Convert.ToString(row["IDCourse"]),
         usu_nickname = Convert.ToString(row["IDCourse"]),
         usu_telefono = Convert.ToString(row["IDCourse"]),
         usu_imagen = Convert.ToString(row["IDCourse"]),
         usu_handicapindex = Convert.ToDecimal(row["IDCourse"]),
        usu_ghinnumber = Convert.ToInt32(row["IDCourse"]),
