...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/ListadoInvitadosAgregar")]
    public class ListadoInvitadosAgregarController : ApiController
    {
        ...
        public JObject Post(ParametrosEntradas Datos)
        {
            try
            {
                SqlCommand comando = new SqlCommand("DragoGolf_ListGuest_Ronda");
