...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/EliminarHoles")]
    public class EliminarHolesController : ApiController
    {
        public class ParametrosEntradas
        {
            ...
            public JObject Post(ParametrosEntradas Datos)
            {
                try
                {
                    SqlCommand comando = new SqlCommand("DragoGolf_DeleteHoles");
                ...
                comando.Parameters["@IDHoles"].Value = Datos.IDHoles;
