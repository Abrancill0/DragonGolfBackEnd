...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/ActualizaSettingsFriend")]
    public class ActualizaSettingsFriendController : ApiController
    {
        ...
        public JObject Post(ParametrosEntradas Datos)
        {
            try
            {
                SqlCommand comando = new SqlCommand("DragoGolf_UpdateSettingsPlayer");
