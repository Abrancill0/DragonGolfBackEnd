...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/ListadoTeesRondaBetDetails")]
    public class ListadoTeesRondaBetDetailsController : ApiController
    {
        ...
        public JObject Post(ParametrosEntradas Datos)
        {
            try
            {
                SqlCommand comando = new SqlCommand("DragoGolf_ListTeesRounds_BetDetail");
