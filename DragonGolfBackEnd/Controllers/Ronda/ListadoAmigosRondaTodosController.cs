                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in DT.Rows)
                    {
                        ...
                        if (Estatus == 1)
                        {
                            ...
                            //Adv = Convert.ToDecimal(row["usu_golpesventaja"]);
                            ...
                            ParametrosSalida ent = new ParametrosSalida
                            {
                                ...
                                //ventaja = ventaja,
                                GolpesVentaja1_tee = GolpesVentaja1_1,
                                GolpesVentaja2_tee = GolpesVentaja2_1,
                                GolpesVentaja3_tee = GolpesVentaja3_1,
                                GolpesVentaja4_tee = GolpesVentaja4_1,
                                GolpesVentaja5_tee = GolpesVentaja5_1,
                                GolpesVentaja6_tee = GolpesVentaja6_1,
                                GolpesVentaja7_tee = GolpesVentaja7_1,
                                GolpesVentaja8_tee = GolpesVentaja8_1,
                                GolpesVentaja9_tee = GolpesVentaja9_1,
                                GolpesVentaja10_tee = GolpesVentaja10_1,
                                GolpesVentaja11_tee = GolpesVentaja11_1,
                                GolpesVentaja12_tee = GolpesVentaja12_1,
                                GolpesVentaja13_tee = GolpesVentaja13_1,
                                GolpesVentaja14_tee = GolpesVentaja14_1,
                                GolpesVentaja15_tee = GolpesVentaja15_1,
                                GolpesVentaja16_tee = GolpesVentaja16_1,
                                GolpesVentaja17_tee = GolpesVentaja17_1,
                                GolpesVentaja18_tee = GolpesVentaja18_1,
                            };
