...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/ValidaDetalleApuestaTeam")]
    public class ValidaDetalleApuestaTeamController : ApiController
    {
        ...
        public JObject Post(ParametrosEntrada Datos)
        {
            try
            {
                SqlCommand comando = new SqlCommand("DragoGolf_ValidateCreateDetailBetTeam");
