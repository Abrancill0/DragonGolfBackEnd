...
namespace DragonGolfBackEnd.Controllers
{
    ...
    [RoutePrefix("api/ActualizarDetalleApuestaTeam")]
    public class ActualizarDetalleApuestaTeamController : ApiController
    {
        ...
        public JObject Post(ParametrosEntrada Datos)
        {
            try
            {
                SqlCommand comando = new SqlCommand("DragonGolf_UpdateDetailBetTeam_1");
