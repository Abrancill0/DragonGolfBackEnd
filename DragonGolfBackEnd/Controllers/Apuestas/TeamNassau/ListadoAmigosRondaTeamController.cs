                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in DT.Rows)
                    {
                        ...
                        if (Estatus == 1)
                        {
                            ...
                            int[] DificultatHoyo_tee_Array = new int[] {0, DificultatHoyo1_tee,
                            DificultatHoyo2_tee,
                            DificultatHoyo3_tee,
                            DificultatHoyo4_tee,
                            DificultatHoyo5_tee,
                            ...
                            DificultatHoyo8_tee,
                            DificultatHoyo9_tee,
                            DificultatHoyo10_tee,
                            DificultatHoyo11_tee,
                            DificultatHoyo12_tee,
                            DificultatHoyo13_tee,
                            DificultatHoyo14_tee,
                            DificultatHoyo15_tee,
                            DificultatHoyo16_tee,
                            DificultatHoyo17_tee,
                            DificultatHoyo18_tee};

                            Double[] ScoreHole_P1_Array = new Double[] {0, ScoreHole1,
                            ScoreHole2,
                            ScoreHole3,
                            ScoreHole4,
                            ScoreHole5,
                            ...
                            double[] GolpesVentaja_tee_Array = new double[] {0,GolpesVentaja1_tee,
                                GolpesVentaja2_tee,
                                GolpesVentaja3_tee,
                                GolpesVentaja4_tee,
                                GolpesVentaja5_tee,
                            ...
                            if (AdvInverso < 0)
                            {
                                ...
                                for (int i = 0; i < CicloFor; i++)
                                {
                                    ...
                                    if (Contadorcito <= AdvPositivo)
                                    {
                                        ...
                                        for (int e = 1; e <= 18; e++)
                                        {
                                            if (DificultatHoyo_tee_Array[e] == Contadorcito)
                                            {
                                                if (TipoGolpesVentaja == "Hi Handicap")
                                                {
                                                    ...
                                                    if ((HandicapP1 + Desempate) > HandicapP3 && Bet_CambioVentaja == false)
                                                    {
                                                        if (Player == "Jugador 1")
                                                        {
                                                            ...
                                                            if (Contadorcito == AdvPositivo)
                                                            {
                                                                GolpesVentaja_tee_Array[e] = GolpesVentaja_tee_Array[e] - (0.5 + ValCompleto);
                                                            }
                                                            else
                                                            {
                                                                GolpesVentaja_tee_Array[e] = GolpesVentaja_tee_Array[e] - 1;
                                                            }
                                                        }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if (HandicapP1 < (HandicapP3 + Desempate2) && Bet_CambioVentaja == true)
                                                            {
                                                                if (Player == "Jugador 3")
                                                                {
                                                                    if (Contadorcito == AdvPositivo)
                                        ...
                                        for (int e = 1; e <= 18; e++)
                                        {
                                            if (DificultatHoyo_tee_Array[e] == Contadorcito)
                                            {
                                                if (TipoGolpesVentaja == "Hi Handicap")
                                                {
                                                    ...
                                                    if ((HandicapP2 + Desempate) > HandicapP4 && Bet_CambioVentaja == false)
                                                    {
                                                        if (Player == "Jugador 2")
                                                        {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if (HandicapP2 < (HandicapP4 + Desempate2) && Bet_CambioVentaja == true)
                                                            {
                                                                if (Player == "Jugador 4")
                                                                {
                                                                    if (Contadorcito == AdvPositivo)
                            ...
                            GolpesVentaja1_tee = GolpesVentaja_tee_Array[1];
                            GolpesVentaja2_tee = GolpesVentaja_tee_Array[2];
                            GolpesVentaja3_tee = GolpesVentaja_tee_Array[3];
                            GolpesVentaja4_tee = GolpesVentaja_tee_Array[4];
                            GolpesVentaja5_tee = GolpesVentaja_tee_Array[5];
                            GolpesVentaja6_tee = GolpesVentaja_tee_Array[6];
                            GolpesVentaja7_tee = GolpesVentaja_tee_Array[7];
                            GolpesVentaja8_tee = GolpesVentaja_tee_Array[8];
                            GolpesVentaja9_tee = GolpesVentaja_tee_Array[9];
                            GolpesVentaja10_tee = GolpesVentaja_tee_Array[10];
                            GolpesVentaja11_tee = GolpesVentaja_tee_Array[11];
                            GolpesVentaja12_tee = GolpesVentaja_tee_Array[12];
                            GolpesVentaja13_tee = GolpesVentaja_tee_Array[13];
                            GolpesVentaja14_tee = GolpesVentaja_tee_Array[14];
                            GolpesVentaja15_tee = GolpesVentaja_tee_Array[15];
                            GolpesVentaja16_tee = GolpesVentaja_tee_Array[16];
                            GolpesVentaja17_tee = GolpesVentaja_tee_Array[17];
                            GolpesVentaja18_tee = GolpesVentaja_tee_Array[18];

                            GolpesVentaja1 = GolpesVentaja_tee_Array[1];
                            GolpesVentaja2 = GolpesVentaja_tee_Array[2];
                            GolpesVentaja3 = GolpesVentaja_tee_Array[3];
                            GolpesVentaja4 = GolpesVentaja_tee_Array[4];
                            GolpesVentaja5 = GolpesVentaja_tee_Array[5];
                            GolpesVentaja6 = GolpesVentaja_tee_Array[6];
                            GolpesVentaja7 = GolpesVentaja_tee_Array[7];
                            GolpesVentaja8 = GolpesVentaja_tee_Array[8];
                            GolpesVentaja9 = GolpesVentaja_tee_Array[9];
                            GolpesVentaja10 = GolpesVentaja_tee_Array[10];
                            GolpesVentaja11 = GolpesVentaja_tee_Array[11];
                            GolpesVentaja12 = GolpesVentaja_tee_Array[12];
                            GolpesVentaja13 = GolpesVentaja_tee_Array[13];
                            GolpesVentaja14 = GolpesVentaja_tee_Array[14];
                            GolpesVentaja15 = GolpesVentaja_tee_Array[15];
                            GolpesVentaja16 = GolpesVentaja_tee_Array[16];
                            GolpesVentaja17 = GolpesVentaja_tee_Array[17];
                            GolpesVentaja18 = GolpesVentaja_tee_Array[18];
